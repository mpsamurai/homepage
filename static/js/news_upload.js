                ...
                return (canvasElem) => {
                    return (valAdjustRectangleSelectionSize) => {
                        ...
                        canvasElem.addEventListener('mousedown', (e) => {
                            ...
                            console.log(e.target.xStartingPoint)
                            console.log(e.target.yStartingPoint)
...
*/
            ...
            adjustRectangleSelectionSize(_this) {
                return (e) => {
                    ...
                    e.target.xEndPoint = e.pageX - _this.canvasElem.offsetLeft - _this.canvasElem.canvasBorderWidth + _this.canvasContainerElem.scrollLeft;;
